...
<head>
    ...
    <meta name="description"
        content="<?php echo htmlspecialchars($nombre_vehiculo_completo . ' - ' . $precio_formateado . ' USD. ' . ($vehiculo['veh_descripcion'] ? substr($vehiculo['veh_descripcion'], 0, 150) . '...' : 'Vehículo en venta en AutoMercado Total.')); ?>">
    <meta name="keywords"
        content="<?php echo htmlspecialchars($vehiculo['mar_nombre'] . ', ' . $vehiculo['mod_nombre'] . ', ' . $vehiculo['veh_anio'] . ', ' . $vehiculo['veh_condicion'] . ', auto, venta'); ?>">

    <meta property="og:title" content="<?php echo htmlspecialchars($nombre_vehiculo_completo); ?>">
    <meta property="og:description"
        content="<?php echo htmlspecialchars($precio_formateado . ' USD - ' . ($vehiculo['veh_descripcion'] ? substr($vehiculo['veh_descripcion'], 0, 150) . '...' : 'Vehículo en venta')); ?>">
...
<body class="vehicle-detail-page">
    <div id="page-loader" class="page-loader">
        <div class="loader-content">
            <l-trefoil size="50" stroke="5" stroke-length="0.15" bg-opacity="0.1" speed="1.4" color="#dc2626">
            </l-trefoil>
        ...
        <section class="breadcrumb-section">
            <div class="container">
                <nav aria-label="breadcrumb" class="custom-breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="inicio.php"><i class="bi bi-house-fill"></i> Inicio</a>
                        </li>
                        <li class="breadcrumb-item"><a
                                href="autos_<?php echo htmlspecialchars($vehiculo['veh_condicion']); ?>s.php">Autos
                ...
                <div class="col-lg-8">
                    <div class="vehicle-gallery fade-in-left">
                        <div class="gallery-main">
                            <div class="main-image-container">
                                <a href="<?php echo $imagen_principal_url; ?>" data-lightbox="galeria-vehiculo"
                                    data-title="<?php echo $nombre_vehiculo_completo; ?>" class="main-image-link">
                                    <img src="<?php echo $imagen_principal_url; ?>"
                                        alt="<?php echo $nombre_vehiculo_completo; ?>" class="main-image"
                                        id="imagenPrincipalVehiculo">
                                    <div class="image-overlay"><i class="bi bi-zoom-in"></i><span>Ver en tamaño
                                            completo</span></div>
                                </a>
                                <div class="image-counter"><i
                                        class="bi bi-images"></i><span><?php echo count($imagenes) > 0 ? count($imagenes) : 1; ?>
                                        fotos</span></div>
                            </div>
                        </div>
                        ...
                        <div class="gallery-thumbnails">
                            <div class="thumbnails-container">
                                ...
                                <div
                                    class="thumbnail-item <?php echo ($url_miniatura === $imagen_principal_url) ? 'active' : ''; ?>">
                                    <a href="<?php echo $url_miniatura; ?>" data-lightbox="galeria-vehiculo"
                                        data-title="<?php echo $nombre_vehiculo_completo; ?>">
                                        <img src="<?php echo $url_miniatura; ?>" alt="Vista <?php echo $index + 1; ?>"
                                            class="thumbnail-image" data-fullimage="<?php echo $url_miniatura; ?>">
                                    </a>
                                </div>
                                <?php endforeach; ?>
                            </div>
                    ...
                    <div class="detail-block reveal-on-scroll mt-5">
                        ...
                        <div class="detail-content">
                            <p><?php echo nl2br(htmlspecialchars($vehiculo['veh_descripcion'] ?: 'No se proporcionó una descripción detallada para este vehículo.')); ?>
                            </p>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="detail-list">
                                        <div class="detail-item"><span class="detail-label">Color Exterior:</span> <span
                                                class="detail-value"><?php echo htmlspecialchars($vehiculo['veh_color_exterior'] ?: 'N/D'); ?></span>
                                        </div>
                                        <div class="detail-item"><span class="detail-label">Color Interior:</span> <span
                                                class="detail-value"><?php echo htmlspecialchars($vehiculo['veh_color_interior'] ?: 'N/D'); ?></span>
                                        </div>
                                        <div class="detail-item"><span class="detail-label">Dirección:</span> <span
                                                class="detail-value"><?php echo htmlspecialchars($vehiculo['veh_tipo_direccion'] ?: 'N/D'); ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="detail-list">
                                        <div class="detail-item"><span class="detail-label">Vidrios:</span> <span
                                                class="detail-value"><?php echo htmlspecialchars($vehiculo['veh_tipo_vidrios'] ?: 'N/D'); ?></span>
                                        </div>
                                        <div class="detail-item"><span class="detail-label">Climatización:</span> <span
                                                class="detail-value"><?php echo htmlspecialchars($vehiculo['veh_sistema_climatizacion'] ?: 'N/D'); ?></span>
                                        </div>
                                        <?php if ($vehiculo['veh_condicion'] == 'usado' && !empty($vehiculo['veh_placa_provincia_origen']) && !empty($vehiculo['veh_ultimo_digito_placa'])): ?>
                                        <div class="detail-item"><span class="detail-label">Matrícula:</span> <span
                                                class="detail-value"><?php echo htmlspecialchars($vehiculo['veh_placa_provincia_origen']); ?>
                                                - termina en
                                                <?php echo htmlspecialchars($vehiculo['veh_ultimo_digito_placa']); ?></span>
                                        </div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                    ...
                    <div class="detail-block reveal-on-scroll">
                        <h3 class="detail-title"><i class="bi bi-check-circle-fill"></i> Características Adicionales
                        </h3>
                        <div class="detail-content">
                            <div class="features-grid">
                                <?php foreach ($detalles_extra_array as $detalle_extra): ?>
                                <div class="feature-item"><i class="bi bi-check-lg"></i>
                                    <span><?php echo htmlspecialchars($detalle_extra); ?></span></div>
                                <?php endforeach; ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="sidebar-sticky">
                        <div class="vehicle-info fade-in-right">
                            <div class="vehicle-header stagger-1">
                                <div class="condition-badge <?php echo $vehiculo['veh_condicion']; ?>">
                                    <?php echo htmlspecialchars(ucfirst($vehiculo['veh_condicion'])); ?></div>
                            ...
                            <div class="price-section stagger-2">
                                <div class="price-main"><span class="currency">$</span><span
                                        class="amount"><?php echo $precio_formateado; ?></span><span
                                        class="currency-code">USD</span></div>
                            ...
                            <div class="quick-info stagger-3">
                                <div class="info-grid">
                                    <div class="info-item"><i class="bi bi-calendar-check"></i>
                                        <div class="info-content"><span class="info-label">Año</span><span
                                                class="info-value"><?php echo htmlspecialchars($vehiculo['veh_anio']); ?></span>
                                        </div>
                                    </div>
                                    <?php if ($vehiculo['veh_condicion'] == 'usado'): ?>
                                    <div class="info-item"><i class="bi bi-speedometer2"></i>
                                        <div class="info-content"><span class="info-label">Recorrido</span><span
                                                class="info-value"><?php echo $kilometraje_formateado; ?></span></div>
                                    </div>
                                    <?php endif; ?>
                                    <div class="info-item"><i class="bi bi-geo-alt-fill"></i>
                                        <div class="info-content"><span class="info-label">Ubicación</span><span
                                                class="info-value"><?php echo htmlspecialchars($vehiculo['veh_ubicacion_ciudad'] . ", " . $vehiculo['veh_ubicacion_provincia']); ?></span>
                                        </div>
                                    </div>
                                    <div class="info-item"><i class="bi bi-clock-fill"></i>
                                        <div class="info-content"><span class="info-label">Publicado</span><span
                                                class="info-value"><?php echo date("d/m/Y", strtotime($vehiculo['veh_fecha_publicacion'])); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="contact-section stagger-4">
                                ...
                                <div class="owner-notice"><i class="bi bi-info-circle-fill"></i><span>Este es uno de tus
                                        vehículos publicados</span></div>
                                <a href="mis_vehiculos.php" class="btn btn-primary btn-lg w-100"><i
                                        class="bi bi-car-front-fill"></i> Gestionar Mis Vehículos</a>
                                <?php else: ?>
                                ...
                                <a href="https://wa.me/593<?php echo substr(preg_replace('/[^0-9]/', '', $vehiculo['gestor_telefono']), -9); ?>?text=Hola, me interesa el <?php echo urlencode($nombre_vehiculo_completo); ?> (ID: <?php echo $veh_id; ?>) que vi en AutoMercado Total."
                                    target="_blank" class="btn btn-whatsapp btn-lg w-100 mb-3"><i
                                        class="bi bi-whatsapp"></i> Contactar por WhatsApp</a>
                                <?php endif; ?>
                                <?php if (isset($_SESSION['usu_id'])): ?>
                                <button class="btn btn-secondary btn-lg w-100" data-bs-toggle="modal"
                                    data-bs-target="#modalAgendarCita">
                                    <i class="bi bi-calendar-plus-fill"></i> Agendar una Cita
                                </button>
                                <?php else: ?>
                            ...
                            <div class="action-card reveal-on-scroll mt-4">
                                ...
                                <div class="action-buttons">
                                    <?php if (isset($_SESSION['usu_id'])): ?>
                                    <button class="btn btn-outline-danger w-100 btn-favoritos"
                                        data-veh-id="<?php echo $veh_id; ?>">
                                        <i class="bi bi-heart"></i> <span id="favText">Agregar a Favoritos</span>
                                    </button>
                                    <?php else: ?>
                                    <a href="login.php?redirect=detalle_vehiculo.php?id=<?php echo $veh_id; ?>"
                                        class="btn btn-outline-danger w-100"><i class="bi bi-heart"></i> Agregar a
                                        Favoritos</a>
                                    <?php endif; ?>
                                    <button class="btn btn-outline-secondary w-100 btn-share"
                                        data-share-title="<?php echo urlencode($nombre_vehiculo_completo); ?>"
                                        data-share-url="<?php echo urlencode('http://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']); ?>">
    ...
    <!-- Modal para Agendar Cita (VERSIÓN FINAL Y REFORZADA) -->
    <?php if (isset($_SESSION['usu_id'])): ?>
    <div class="modal fade" id="modalAgendarCita" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalLabel"><i class="bi bi-calendar-plus-fill me-2"></i>Agendar una
                        Cita</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form id="formAgendarCita" data-veh-id="<?php echo $veh_id; ?>">
                    <div class="modal-body">
                        ...
                        <p>Selecciona una fecha y hora disponibles para ver este vehículo. Un gestor confirmará tu cita.
                        </p>

                        <div class="mb-3">
                            <label for="cita_fecha_input" class="form-label"><strong>1. Elige una fecha
                                    disponible:</strong></label>
                            <!-- 'name' añadido para que FormData lo recoja -->
                            <input type="text" id="cita_fecha_input" name="fecha_disponibilidad" class="form-control"
                                placeholder="Selecciona un día..." readonly="readonly">
                        </div>

                        <div class="mb-3">
                            <label for="cita_hora_input" class="form-label"><strong>2. Elige una hora
                                    disponible:</strong></label>
                            <!-- 'name' añadido para que FormData lo recoja -->
                            <input type="text" id="cita_hora_input" name="hora_disponibilidad" class="form-control"
                                placeholder="Primero elige una fecha..." readonly="readonly">
                        </div>

                        <div class="mb-3">
                            <label for="cita_mensaje" class="form-label"><strong>3. Mensaje Adicional
                                    (Opcional):</strong></label>
                            <!-- 'name' añadido para que FormData lo recoja -->
                            <textarea class="form-control" id="cita_mensaje" name="mensaje" rows="3"
                                placeholder="Ej: Me gustaría asegurarme de que el aire acondicionado funcione perfectamente."></textarea>
                        </div>

                        <div id="citaFormMessage" class="mt-3"></div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                        <button type="submit" class="btn btn-danger" id="btnSolicitarCita" disabled>
                            <i class="bi bi-send-fill me-2"></i>Solicitar Cita
                        </button>
                    </div>
                </form>
            </div>
    ...
    <!-- Opcional: para traducción al español -->
