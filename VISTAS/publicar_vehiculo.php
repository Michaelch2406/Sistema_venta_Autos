    ...
    <main class="flex-grow-1 content-hidden">
        <div class="container py-4">
            <div class="pt-4 mb-4 text-center">
                ...
                <p class="lead text-muted col-lg-8 mx-auto">Ingresa los detalles de tu vehículo. Los campos con <span
                        class="text-danger fw-bold">*</span> son obligatorios.</p>
            </div>
            <form id="publicarVehiculoForm" class="needs-validation" novalidate enctype="multipart/form-data">
                ...
                <div class="card-form-section">
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <label for="tiv_id" class="form-label">Tipo de Vehículo <span
                            ...
                            <div class="col-md-6"><label for="veh_subtipo_vehiculo" class="form-label">Subtipo <span
                ...
                <div class="card-form-section">
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            <div class="col-md-6"><label for="veh_ubicacion_provincia" class="form-label">Provincia
                                    Dónde se Encuentra <span class="text-danger">*</span></label><select
                                    class="form-select" id="veh_ubicacion_provincia" name="veh_ubicacion_provincia"
                                    required>
                                    <option value="" selected disabled>Selecciona...</option>
                                </select>
                            ...
                            <div class="col-md-6"><label for="veh_color_interior" class="form-label">Color
                                    ...
                                    name="veh_color_interior" placeholder="Ej: Cuero negro"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-form-section">
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            <div class="col-md-12"><label for="veh_detalles_motor" class="form-label">Detalles del Motor
                            ...
                            <div class="col-md-4"><label for="veh_tipo_transmision"
                                    ...
                                    id="veh_tipo_transmision" name="veh_tipo_transmision">
                            ...
                            <div class="col-md-4"><label for="veh_traccion" class="form-label">Tracción</label><select
                                    class="form-select" id="veh_traccion" name="veh_traccion">
                                    <option value="" selected>Opcional...</option>
                            ...
                            <div class="col-md-4"><label for="veh_tipo_combustible"
                                    class="form-label">Combustible</label><select class="form-select"
                                    id="veh_tipo_combustible" name="veh_tipo_combustible">
                                    <option value="" selected>Opcional...</option>
                            ...
                            <div class="col-md-4"><label for="veh_tipo_direccion"
                                    class="form-label">Dirección</label><select class="form-select"
                                    id="veh_tipo_direccion" name="veh_tipo_direccion">
                                    <option value="" selected>Opcional...</option>
                            ...
                            <div class="col-md-4"><label for="veh_tipo_vidrios"
                                    class="form-label">Vidrios</label><select class="form-select" id="veh_tipo_vidrios"
                                    name="veh_tipo_vidrios">
                                    <option value="" selected>Opcional...</option>
                                    <option value="Manuales">Manuales</option>
                                    <option value="Electricos Delanteros">Eléctricos Delanteros</option>
                                    <option value="Electricos Completos">Eléctricos Completos</option>
                                    <option value="Otro">Otro</option>
                                </select></div>
                            <div class="col-md-4"><label for="veh_sistema_climatizacion"
                                    class="form-label">Climatización</label><select class="form-select"
                                    id="veh_sistema_climatizacion" name="veh_sistema_climatizacion">
                                    <option value="" selected>Opcional...</option>
                                    <option value="Ninguno">Ninguno</option>
                                    <option value="Aire Acondicionado">A/C</option>
                                    <option value="Climatizador Manual">Climatizador Manual</option>
                                    <option value="Climatizador Automatico">Climatizador Automático</option>
                ...
                <div class="card-form-section">
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            <div class="col-12">
                                <label class="form-label">Detalles Extra <span class="text-muted">(Selecciona los que
                                        apliquen)</span></label>
                                <div class="optional-fields-group p-3 border rounded">
                                    <div class="row">
                                        <div class="col-sm-6 col-md-4">
                                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                                    value="Acepto Vehiculo Como Parte de Pago" id="extraAceptoVehiculo"
                                                    name="veh_detalles_extra[]"><label class="form-check-label"
                                                    for="extraAceptoVehiculo">Acepto Vehículo (Parte Pago)</label></div>
                                        </div>
                                        <div class="col-sm-6 col-md-4">
                                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                                    value="Unico Dueño" id="extraUnicoDueno"
                                                    name="veh_detalles_extra[]"><label class="form-check-label"
                                                    for="extraUnicoDueno">Único Dueño</label></div>
                                        </div>
                                        <div class="col-sm-6 col-md-4">
                                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                                    value="Garantia de Casa Vigente" id="extraGarantiaCasa"
                                                    name="veh_detalles_extra[]"><label class="form-check-label"
                                                    for="extraGarantiaCasa">Garantía de Casa</label></div>
                                        </div>
                                        <div class="col-sm-6 col-md-4">
                                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                                    value="Documentos al Dia" id="extraDocumentosDia"
                                                    name="veh_detalles_extra[]"><label class="form-check-label"
                                                    for="extraDocumentosDia">Documentos al Día</label></div>
                                        </div>
                                        <div class="col-sm-6 col-md-4">
                                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                                    value="Matricula Pagada" id="extraMatriculaPagada"
                                                    name="veh_detalles_extra[]"><label class="form-check-label"
                                                    for="extraMatriculaPagada">Matrícula Pagada</label></div>
                                        </div>
                                        <div class="col-sm-6 col-md-4">
                                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                                    value="Negociable" id="extraNegociable"
                                                    name="veh_detalles_extra[]"><label class="form-check-label"
                                                    for="extraNegociable">Precio Negociable</label></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
