            ...
            <div class="card-body p-4 p-md-5">
              ...
              <form id="registroForm" class="row g-3 needs-validation" novalidate>
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" id="regUsuario" name="usu_usuario" placeholder="Ej: juanperez88" required>
                  <div class="invalid-feedback">Por favor, ingresa un nombre de usuario.</div>
                </div>
                <div class="col-md-6">
                  <label for="regNombre" class="form-label">Nombre(s)</label>
                  <input type="text" class="form-control" id="regNombre" name="usu_nombre" placeholder="Juan Carlos" required>
                  <div class="invalid-feedback">Por favor, ingresa tu nombre.</div>
                </div>
                <div class="col-md-6">
                  <label for="regApellido" class="form-label">Apellido(s)</label>
                  <input type="text" class="form-control" id="regApellido" name="usu_apellido" placeholder="Pérez Gómez" required>
                  <div class="invalid-feedback">Por favor, ingresa tu apellido.</div>
                </div>
                <div class="col-md-6">
                  <label for="regEmail" class="form-label">Correo Electrónico</label>
                  <input type="email" class="form-control" id="regEmail" name="usu_email" placeholder="nombre@ejemplo.com" required>
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" id="regCedula" name="usu_cedula" placeholder="Ej: 1712345678" required pattern="\d{10,13}">
                ...
                <div class="col-md-6">
                  ...
                  <div class="input-group">
                    <input type="password" class="form-control" id="regPassword" name="usu_password" placeholder="Mínimo 8 caracteres" required minlength="8">
                    <button class="btn btn-outline-secondary toggle-password" type="button" data-target="regPassword"><i class="bi bi-eye-slash"></i></button>
                ...
                <div class="col-md-6">
                  ...
                  <div class="input-group">
                    <input type="password" class="form-control" id="regPasswordConfirm" name="usu_password_confirm" placeholder="Repite tu contraseña" required minlength="8">
                    <button class="btn btn-outline-secondary toggle-password" type="button" data-target="regPasswordConfirm"><i class="bi bi-eye-slash"></i></button>
                    <div class="invalid-feedback" id="passwordConfirmError">Las contraseñas no coinciden.</div>
                  </div>
                </div>
                <div class="col-md-6">
                  <label for="regTelefono" class="form-label">Teléfono <span class="text-muted">(Opcional)</span></label>
                  <input type="tel" class="form-control" id="regTelefono" name="usu_telefono" placeholder="0991234567">
                </div>
                <div class="col-md-6">
                  <label for="regFnacimiento" class="form-label">Fecha de Nacimiento <span class="text-muted">(Opcional)</span></label>
                  <input type="date" class="form-control" id="regFnacimiento" name="usu_fnacimiento">
                </div>
                <div class="col-12">
                  <label for="regDireccion" class="form-label">Dirección <span class="text-muted">(Opcional)</span></label>
                  <input type="text" class="form-control" id="regDireccion" name="usu_direccion" placeholder="Calle Principal 123 y Secundaria">
                </div>
                <div class="col-12">
                  <div class="form-check mt-2">
                    <input class="form-check-input" type="checkbox" id="terms" name="accept_terms" required>
                    <label class="form-check-label" for="terms"> Acepto los <a href="terminos.html" target="_blank">términos y condiciones</a></label>
