...
<head>
    ...
    <!-- Estilos Específicos para la Administración de Marcas y Modelos -->
    <link href="./CSS/admin_marcas_modelos.css" rel="stylesheet">
...
<body class="d-flex flex-column min-vh-100 bg-light">
    ...
    <script src="./JS/admin_marcas_modelos.js"></script>
</body>
</html>
