...
<head>
    ...
    <link href="./CSS/escritorio.css" rel="stylesheet">
    ...
    <main class="flex-grow-1 content-hidden">
        <div class="container py-5">
            <div class="dashboard-header pt-4 mb-5">
                ...
                <?php elseif ($rol_id == 2): ?>
                <p>Desde aquí puedes asistir a los clientes, gestionar vehículos y revisar las actividades de la
                    plataforma.</p>
                <?php endif; ?>
            </div>
            ...
            <div class="row g-4 dashboard-cards">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100 dashboard-card shadow-sm">
                        <div class="card-body text-center d-flex flex-column">
                            ...
                            <p class="card-text text-muted small">Publica tu vehículo usado en pocos pasos y llega a
                                miles de compradores.</p>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100 dashboard-card shadow-sm">
                        <div class="card-body text-center d-flex flex-column">
                            ...
                            <p class="card-text text-muted small">Gestiona tus anuncios, actualiza información y
                                responde a interesados.</p>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100 dashboard-card shadow-sm">
                        <div class="card-body text-center d-flex flex-column">
                            ...
                            <p class="card-text text-muted small">Revisa los vehículos que has marcado como favoritos.
                            </p>
                ...
                <div class="col-12 mt-4">
                    <a href="logout.php" class="btn btn-outline-danger"><i class="bi bi-box-arrow-right me-2"></i>Cerrar
                        Sesión</a>
                </div>
            </div>
        </div>
